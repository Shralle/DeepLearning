...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        skip4 = torch.cat((layer4, layer6up4), dim = 3)
        ...
        skip3 = torch.cat((layer3, layer7up3), dim = 3)
        ...
        skip2 = torch.cat((layer2, layer8up2), dim =3)
        ...
        skip1 = torch.cat((layer1, layer9up2), dim = 3)
