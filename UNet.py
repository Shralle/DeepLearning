...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True):
        ...
        self.down = MaxPool2d(kernel_size=(2,2))
        ...
        self.conv6up4 = Conv2d(1024,512, kernel_size = 2)#, padding = 1)
        self.conv6 = Conv2d(512, 512, kernel_size=3)#, padding=1)
        self.conv7up3 = Conv2d(512,256, kernel_size = 2)#, padding = 1)
        self.conv7 = Conv2d(256, 256, kernel_size=3)#, padding=1)
        self.conv8up2 = Conv2d(256,128, kernel_size = 2)#, padding = 1)
        self.conv8 = Conv2d(128, 128, kernel_size=3)#, padding=1)
        self.conv9up1 = Conv2d(128,64, kernel_size = 2)#, padding = 1)
    ...
    def forward(self, x):
        ...
        layer8up2 = self.conv9up1(layer9up1)
